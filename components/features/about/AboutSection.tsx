...
export function AboutSection() {
  return (
    <AnimatedSection direction="up" delay={0.15}>
      ...
      >
        <div className="bg-linear-to-br from-muted/60 via-muted/20 to-background px-4 md:px-6 pt-5 md:pt-6 pb-6 md:pb-7">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6 items-start">
            ...
            <div className="border rounded-xl p-4 bg-background/70 min-w-40 flex flex-col gap-3">
